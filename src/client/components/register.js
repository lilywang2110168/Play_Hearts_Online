    ...
    onUsernameChange(ev) {
        ...
        if (!ev.target.value) {
            ...
            $.ajax({
                ...
                method: "head",
                success: () => {
                    errorEl.innerHTML = `Username already in use`;
                ...
                <form className="form-horizontal">
                    <div className="form-group">
                        ...
                        <div className="col-sm-10">
                            <input className="form-control" id="username" type="text" placeholder="Username" onChange={this.onUsernameChange}/>
                        </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <div className="col-sm-offset-2 col-sm-10">
                            <button onClick={this.onSubmit} className="btn btn-default" disabled={this.state.disabled}>Register</button>
                        </div>
                    </div>
                </form>
            </div>
